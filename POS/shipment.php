...
<!-- your main container -->
    ...
    <div class="col-sm-12">
      <div class="input-group">
        <a class="btn btn-primary" name="submit" href="addshipment.php">Add Shipment</a>
      </div>
    </div>
    ...
    <div class="clearfix"></div>
        ...
        <?php
        include("config.php");     
        $query="SELECT order_shipment.*,supplier.name FROM order_shipment left join supplier ON order_shipment.supplier_id = supplier.id";
        ...
        <div class="block-flat">
          ...
          <div class="content">
           ...
           <tr>
            ...
            <td>
            <font face="Arial, Helvetica, sans-serif">Containor No</font>
            </td>
            <td>
            <font face="Arial, Helvetica, sans-serif">Arrival Date</font>
            </td>
            <td>
            <font face="Arial, Helvetica, sans-serif">Sent Date</font>
            </td>
            <td>
            ...
            <td>
            <font face="Arial, Helvetica, sans-serif">Supplier Name</font>
            </td>
            <td>
            ...
            <font face="Arial, Helvetica, sans-serif">Delete</font>
              ...
              <tr>
                ...
                <td>
                  <a href="deleteshipment.php?id=<?php echo $f1; ?>" onclick="return confirm('Are you sure to delete it !')" class="btn btn-danger btn-rad">Delete</a>
                </td>
              </tr>
              <?php
                }
